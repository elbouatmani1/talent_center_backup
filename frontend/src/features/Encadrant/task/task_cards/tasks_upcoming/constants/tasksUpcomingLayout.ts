...
export const TASKS_UPCOMING_PAGE_ROOT =
...
export const TASKS_UPCOMING_STAT_CARD =
...
export const TASKS_UPCOMING_SECTION_CARD =
...
export const TASKS_UPCOMING_FILTER_BTN =
...
export const TASKS_UPCOMING_STUDENT_CARD =
  'box-border flex w-full min-w-0 flex-col gap-4 rounded-[14px] border border-solid border-[rgba(0,0,0,0.08)] bg-white p-4 sm:p-5';
