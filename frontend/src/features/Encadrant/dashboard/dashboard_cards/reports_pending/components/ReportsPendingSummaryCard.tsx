...
import { REPORTS_PENDING_STAT_CARD } from '../constants/reportsPendingLayout';
import { REPORTS_PENDING_SUMMARY_STYLES } from '../constants/reportsPendingStyles';
...
const ReportsPendingSummaryCard: FunctionComponent<ReportsPendingSummaryCardProps> = ({ stat }) => {
  const Icon = iconMap[stat.icon];
  const tone = REPORTS_PENDING_SUMMARY_STYLES[stat.tone];

  return (
    <article className={REPORTS_PENDING_STAT_CARD}>
