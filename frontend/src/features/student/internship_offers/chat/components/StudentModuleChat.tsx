...
const StudentModuleChat: FunctionComponent<StudentModuleChatProps> = ({
  ...
  return (
    <StudentLayout contentFlush headerTitle="Chat" headerSubtitle="Digital Talent Center">
      <div
        id="student-chat-root"
        className="font-inter flex h-full min-h-0 w-full max-w-full flex-1 flex-col overflow-hidden"
      >
