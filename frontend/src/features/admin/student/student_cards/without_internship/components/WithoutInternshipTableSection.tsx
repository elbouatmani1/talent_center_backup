...
const statusBadgeClass: Record<'Active' | 'Inactive', string> = {
  Active:
              ...
              students.map((student) => (
                ...
                >
                  ...
                  <td className="box-border min-h-[49px] px-4 py-[13.5px] align-middle">
                    <span className={noneBadgeClass}>{student.internshipStatus}</span>
                  </td>
                  <td className="box-border min-h-[49px] px-4 py-[13.5px] align-middle">
                    <span className={statusBadgeClass[student.statusLabel]}>{student.statusLabel}</span>
                  </td>
