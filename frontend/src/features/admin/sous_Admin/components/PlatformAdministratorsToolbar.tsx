...
const PlatformAdministratorsToolbar: FunctionComponent<PlatformAdministratorsToolbarProps> = ({
  ...
  <div className="flex flex-col gap-5 px-4 pb-1.5 pt-6 md:flex-row md:items-center md:justify-between md:gap-5 md:px-6">
    ...
    <div className="flex w-full flex-col gap-3 md:w-auto md:flex-row md:items-center md:justify-end md:gap-3">
      <div className="relative h-9 w-full md:w-64">
        <Search
      ...
      <button
        ...
        className="inline-flex h-9 shrink-0 items-center justify-center gap-2 self-stretch rounded-num-8 bg-[#101828] px-3 text-center text-num-14 font-medium leading-num-20 text-white transition-colors hover:bg-[#1e2939] md:self-auto"
      >
