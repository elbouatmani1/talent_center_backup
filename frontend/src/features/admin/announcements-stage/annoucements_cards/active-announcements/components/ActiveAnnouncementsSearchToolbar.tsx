  ...
  return (
    <div className="flex flex-col gap-3 border-b border-[rgba(0,0,0,0.1)] px-6 py-4 sm:flex-row sm:items-center">
      ...
      <select
        ...
        value={typeFilter}
        onChange={(e) => onTypeFilterChange(e.target.value as ActiveAnnouncementsTypeFilter)}
        className="box-border h-10 min-w-[10rem] shrink-0 cursor-pointer appearance-none rounded-lg border border-solid border-[rgba(0,0,0,0.1)] bg-white py-2 pl-3 pr-9 font-inter text-sm font-medium leading-5 text-[#0a0a0a] bg-[length:1rem] bg-[right_0.625rem_center] bg-no-repeat"
