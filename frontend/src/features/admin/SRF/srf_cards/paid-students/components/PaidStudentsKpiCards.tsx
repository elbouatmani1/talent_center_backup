...
const PaidStudentsKpiCards: FunctionComponent = () => (
  <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
    {paidStudentsKpis.map(({ label, valueDisplay, Icon }) => (
      <div
        key={label}
      ...
      >
        <div className="box-border flex min-h-[110px] w-full flex-1 items-center justify-between gap-5 p-6">
          ...
          <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#2b7fff]">
