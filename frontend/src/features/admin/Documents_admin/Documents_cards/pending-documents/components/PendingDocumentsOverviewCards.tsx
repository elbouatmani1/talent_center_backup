...
const overviewStats: { label: string; value: string; icon: LucideIcon }[] = [
  { label: 'Total Pending', value: '45', icon: Clock },
  { label: 'Submitted Today', value: '12', icon: Calendar },
  { label: 'Pending >3 Days', value: '8', icon: AlertCircle },
  { label: 'Awaiting Action', value: '45', icon: FileText },
];
