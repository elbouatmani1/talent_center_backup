...
const overviewStats: { label: string; value: string; icon: LucideIcon }[] = [
  ...
  { label: 'Pending Review', value: '45', icon: Clock },
  { label: 'Approved', value: '789', icon: CheckCircle },
  { label: 'Rejected', value: '58', icon: XCircle },
];

/** Cartes résumé pour la vue « Total documents » — toutes les icônes en bleu comme sur la maquette. */
