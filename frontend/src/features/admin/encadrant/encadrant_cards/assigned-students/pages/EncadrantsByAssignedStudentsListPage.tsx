...
import EncadrantsByAssignedStudentsCardHeader from '../components/EncadrantsByAssignedStudentsCardHeader';
    ...
    <AdminLayout>
      <div className="mx-auto max-w-[1600px] space-y-5 pb-6 font-inter">
        ...
        <div className="flex w-full flex-col rounded-[14px] border border-[rgba(0,0,0,0.1)] bg-white">
          <EncadrantsByAssignedStudentsCardHeader totalFormatted={totalFormatted} />
