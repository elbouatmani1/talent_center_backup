...
/**
 * Carte stat cliquable (même visuel que SRFSummaryStatCard) : toute la surface est un vrai <button>,
 * avec retour visuel hover/active pour confirmer le clic.
 */
const EncadrantSummaryStatCard: FunctionComponent<EncadrantSummaryStatCardProps> = ({
  ...
  <button
    ...
    className="relative box-border flex h-[114px] w-full cursor-pointer touch-manipulation flex-col rounded-[14px] border border-solid border-[rgba(0,0,0,0.1)] bg-white text-left font-sans text-sm text-[#717182] shadow-sm outline-none transition-[transform,box-shadow,border-color] duration-150 hover:border-[rgba(0,0,0,0.18)] hover:shadow-md active:scale-[0.99] active:shadow-sm focus-visible:ring-2 focus-visible:ring-[#2b7fff] focus-visible:ring-offset-2"
  >
