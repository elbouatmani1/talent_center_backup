...
const OffersWithApplicationsListSearchToolbar: FunctionComponent<
  OffersWithApplicationsListSearchToolbarProps
> = ({ query, onQueryChange, companyFilter, onCompanyFilterChange, companyOptions }) => {
  return (
