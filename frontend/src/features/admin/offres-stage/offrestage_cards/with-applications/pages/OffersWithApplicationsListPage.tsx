...
import OffersWithApplicationsListCardHeader from '../components/OffersWithApplicationsListCardHeader';
import OffersWithApplicationsListSearchToolbar from '../components/OffersWithApplicationsListSearchToolbar';
