...
const InternshipOffersTable: FunctionComponent = () => {
  return (
    <div className="box-border flex w-full flex-col gap-6 rounded-[14px] border border-solid border-[rgba(0,0,0,0.1)] bg-white text-left font-inter text-base text-gray">
      <div className="flex flex-col gap-5 px-6 pb-1.5 pt-6 lg:flex-row lg:items-center lg:justify-between">
