...
const InternshipOffersToolbar: FunctionComponent = () => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-end gap-2">
      <div className="relative w-full min-w-0 sm:w-64 shrink-0">
        <Search
      ...
      <select
        ...
        className="h-9 min-w-[8rem] shrink-0 cursor-pointer appearance-none rounded-lg border border-solid border-[rgba(0,0,0,0.1)] bg-white bg-[length:1rem] bg-[right_0.5rem_center] bg-no-repeat py-1 pl-3 pr-8 font-inter text-num-14 leading-5 text-gray"
        style={{
      ...
      <button
        ...
        className="flex h-9 shrink-0 items-center gap-2 rounded-lg bg-[#030213] px-3 font-inter text-num-14 font-medium leading-5 text-white hover:opacity-90"
      >
